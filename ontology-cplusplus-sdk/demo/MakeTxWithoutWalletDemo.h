...
class MakeTxWithoutWalletDemo
{
  public:
    ...
    Account acct1 = Account(Helper.hexToBytes(privatekey1), ontSdk.defaultSignScheme);
    Account acct2 = Account(Helper.hexToBytes(privatekey2), ontSdk.defaultSignScheme);
    Account acct3 = Account(Helper.hexToBytes(privatekey3), ontSdk.defaultSignScheme);
    Account acct4 = Account(Helper.hexToBytes(privatekey4), ontSdk.defaultSignScheme);
    Account acct5 = Account(Helper.hexToBytes(privatekey5), ontSdk.defaultSignScheme);
    void transer()
    {
        // Address sender;
