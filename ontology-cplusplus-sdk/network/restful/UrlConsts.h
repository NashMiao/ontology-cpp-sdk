...
struct UrlConsts
{
	...
	std::string Url_get_smartcodeevent_txs_by_height = "/api/v1/smartcode/event/transactions/";
	std::string Url_get_smartcodeevent_by_txhash = "/api/v1/smartcode/event/txhash/";
